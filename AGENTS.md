...
- After fixing hook, policy, lint-capture, runtime, generated-config, or parent integration behavior, run `make build`; otherwise parent-repo agents may still execute stale binaries or configs.
